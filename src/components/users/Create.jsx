...
if(data.message=='success'){
    ...
    return (
       ...
       <Input id={'name'} title={'Name'} type={'text'} name={'name'} changeData={changeData}/>
       <Input id={'email'} title={'Email'} type={'email'} name={'email'} changeData={changeData}/>
       <Input id={'password'} title={'Password'} type={'password'} name={'password'} changeData={changeData}/>
